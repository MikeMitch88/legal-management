// src/components/FormControlsClient.js
///home/mike_mitch/Development/relonKenya/frontend/client/src/components/FormControlsClient/FormControlsClient.jsx
...
const FormControlsClient = ({ select2Case, date_format_datepiker, token }) => {
  ...
  return (
    <form onSubmit={formik.handleSubmit} id="add_client">
      ...
      <div className="form-group">
        ...
        <DatePicker
          ...
          dateFormat={date_format_datepiker}
...
export default FormControlsClient;
