  ...
  return (
      <div >
        ...
        <button className=" btn btn-success" onClick={() => setShowForm(!showForm)}>
            {showForm ? 'Cancel' : 'Client-screening'}
        </button>
          ...
          {showForm && (
              ...
              <form onSubmit={handleSubmit} className="form-container">
                  ...
                  <section className="form-section">
                      <h1>Past Medical and Psychiatric History</h1>
                      <textarea
                  ...
                  <section className="form-section">
                      <h1>Educational and Work History</h1>
                      <textarea
